...
// Match any /auth/ route so error reporting skips every credential-bearing
// endpoint, not just /auth/login + /auth/register. Without this, a 5xx on
// /auth/change-password ships both the old and new passwords to Sentry via
// the serialized axios config.
