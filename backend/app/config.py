...
JWT_ALGORITHM = "HS256"
# 30 days. Single-user, self-hosted; the device passcode is the
# physical security boundary, so a long-lived bearer token here only
# changes how often the user types their password. Trade-off: a leaked
